...
export class RoomSocket {
    ...
    async connect() {
        ...
        this.socket.on('join-room', async (roomToJoin: Room, roomToLeave: string | null, user: string) => {
    ...
    async deleteRoomsOnDisconnect(userName: any) {
        const roomsAfterDelete = await deleteRoomsOnDisconnect(userName, this.roomRepository)
